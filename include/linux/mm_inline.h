...
void lruvec_add_page(struct lruvec *lruvec, struct page *page)
{
...
static __always_inline
void lruvec_add_page_tail(struct lruvec *lruvec, struct page *page)
{
	enum lru_list lru = page_lru(page);
...
static __always_inline
void lruvec_del_page(struct lruvec *lruvec, struct page *page)
{
	if (lru_gen_del_page(lruvec, page, false))
		return;
